...
model {
  ...
  p ~ normal(2.0, 2.0/100); // sd is mean /100
  q ~ normal(0.4, 0.4/100); // sd is mean /100
  #z ~ lognormal(log(1), 2.5); // mode at ~ 0.001
  rmax ~ normal(10.0, 10.0/100);

  prior_p ~ normal(2.0, 2.0/100);
  prior_q ~ normal(0.4, 0.4/100);
  #prior_z ~ lognormal(log(1), 2.5);
  prior_rmax ~ normal(10.0, 10.0/100);
  ...
  #print("p = ", p, " ","q = ", q, " ");
  #print("prob mean = ", mean(prob));
  #print("delta_r mean = ", mean(delta_r));
}
