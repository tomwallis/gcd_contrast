...
model_files <- c(paste0(getwd(),'/output/single_level_transducer.RData'),
...
for (model in 1 : length(model_files)){
  ...
  this_model_num <- model + 2 # for transducer models...
...
pdf(file=paste0(getwd(),'/figs/transducer_multipanel.pdf'),width=6.5,height=6)
